...
// 1.Dynamic Polymorphism (method overriding)- pure virtual function
// 2. static Polymorphism (method overloading)- function overloading
...
Currently, your manualCar class sorts out accelerate(), but it fails to
implement brake(). As a result,manualCar is still considered an abstract class,
and the compiler prevents you from creating a new manualCar at line 99.
